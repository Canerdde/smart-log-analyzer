...
app.include_router(
    search_history.router, prefix="/api/search-history", tags=["Search History"]
)
...
app.include_router(
    aggregation.router, prefix="/api/aggregation", tags=["Log Aggregation"]
)
...
app.include_router(
    correlation.router, prefix="/api/correlation", tags=["Log Correlation"]
)
...
app.include_router(
    performance.router, prefix="/api/performance", tags=["Performance Metrics"]
)
