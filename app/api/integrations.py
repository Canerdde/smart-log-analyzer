...
try:
    from app.integrations import (
        ...
        JiraIntegration, TrelloIntegration
    )
...
async def test_slack_integration(
    ...
    return {
        "success": success,
        "message": "Slack webhook test edildi" if success else "Slack webhook test başarısız"
    }
...
async def test_teams_integration(
    ...
    return {
        "success": success,
        "message": "Teams webhook test edildi" if success else "Teams webhook test başarısız"
    }
...
async def test_jira_integration(
    ...
    return {
        ...
        "issue": issue,
        "message": "Jira integration test edildi" if issue else "Jira integration test başarısız"
    }

@router.post("/trello/test")
async def test_trello_integration(
    request: TrelloTestRequest,
    current_user: User = Depends(get_current_active_user)
):
    ...
    return {
        ...
        "card": card,
        "message": "Trello integration test edildi" if card else "Trello integration test başarısız"
    }
