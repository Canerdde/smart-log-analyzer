...
from app.auth import create_access_token, get_current_active_user, require_role, ACCESS_TOKEN_EXPIRE_MINUTES
...
async def login(
    ...
    print(f"Hash prefix: {user.hashed_password[:20] if user.hashed_password else 'None'}...")
